...
import java.util.StringFormatter;
 ...
 */
public class CurveElement<E extends Element> extends AbstractPointElement<E> implements Streamable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 3822711491161608854L;
	protected int infFlag;
    protected CurveField<?> curveField;

//    public static int counter = 0;

    public CurveElement(){super();}
    ...
    public CurveElement<E> duplicate() {
        return new CurveElement<E>(this);
    }
...
//        counter++;
    ...
    public String toString() {
        return StringFormatter.format("%s,%s,%d", x, y, infFlag);
    }
