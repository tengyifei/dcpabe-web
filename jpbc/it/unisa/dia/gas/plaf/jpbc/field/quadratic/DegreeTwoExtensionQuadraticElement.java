...
public class DegreeTwoExtensionQuadraticElement<E extends Element> extends QuadraticElement<E> {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6560448079804669803L;
	protected DegreeTwoExtensionQuadraticField field;

	private DegreeTwoExtensionQuadraticElement(){super();}
    ...
    public String toString() {
        return StringFormatter.format("{x=%s,y=%s}", x, y);
    }
