 ...
 */
public class GTFiniteElement extends AbstractElement implements Streamable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 5989514235183731513L;
	protected PairingMap pairing;
    protected Element value;

    protected GTFiniteElement(){}
